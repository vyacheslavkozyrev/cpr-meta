...
This document defines the data model for the Personal Goal Management feature, including database schema, entity relationships, and domain models.

**Database**: PostgreSQL 16

---

**Note**: See `data-model-detailed.md` for complete schema definitions, migration scripts, and C#/TypeScript models.
...
| `created_at` | TIMESTAMPTZ | No | CURRENT_TIMESTAMP | Creation timestamp | Auto-managed |
| `modified_by` | UUID | Yes | NULL | User who last modified | FK to users.id |
| `modified_at` | TIMESTAMPTZ | Yes | NULL | Last modification timestamp | Auto-managed by trigger |
...
| Date | Author | Changes |
|------|--------|---------|
| 2025-11-11 | [Name] | Initial data model created |
