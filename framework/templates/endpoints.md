...
This document defines all API endpoints for the [Feature Name] feature, including request/response contracts, validation rules, and authorization requirements.
...
| Date | Author | Changes |
|------|--------|---------|
| [Date] | [Name] | Initial endpoint definitions |
